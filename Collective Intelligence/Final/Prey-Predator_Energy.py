...
class EcosystemConfig(Config):
    ...
    death_Rate = 0.0005
    Predator_Reproduction_Rate = 0.08
    eating_distance = 16
...
df_raw.write_csv("Assignment 2/Results/PreyPredator_Energy.csv")
plot = sns.relplot(x = df_raw["frame"], y = df_raw["AgentCount"], hue = df_raw["AID"], kind = "line")
plot.savefig("Assignment 2/Results/PreyPredator_Energy.png", dpi = 300)
