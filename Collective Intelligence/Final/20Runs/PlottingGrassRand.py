...
for i in range(20):
    Base = pl.read_csv(f"Assignment 2/20Runs/Results/PreyPredator_Grass_Rand{i}.csv")
    ...
    plt.title("Randomly Spawned Grass", fontsize=16)
    plt.xlim(0, 35000/60)
    plt.savefig(f"Assignment 2/20Runs/Figures/Grass_Rand{i}.png")